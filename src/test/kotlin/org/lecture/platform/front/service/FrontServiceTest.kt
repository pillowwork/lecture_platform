...
class FrontServiceTest {
  ...
  fun listLectureTest() {
    ...
    assertEquals(savedPage.content[0].roomName, lectureDto3.roomName)
    assertEquals(savedPage.content[0].capacity, lectureDto3.capacity)
    ...
    assertEquals(savedPage.content[1].roomName, lectureDto3.roomName)
    assertEquals(savedPage.content[1].capacity, lectureDto3.capacity)
